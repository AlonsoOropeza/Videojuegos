...
public class Game implements Runnable{
	...
	public void init()
	{
		...
		// Se crea al jugador
		Player player = new Player(100, 200, 64, 64, Color.WHITE, Assets.marine, handler);
		...
		handler.addObj(new Wall(0, 700, 1366, 32, new Color(0, 0, 0, 0), handler));
		handler.addObj(new Wall(0, 500, 400, 32, new Color(150, 150, 150, 150), handler));
		handler.addObj(new Wall(1000, 350, 400, 32, new Color(150, 150, 150, 150), handler));
	}
	...
	public void render()
	{
		...
		g.setFont(new Font("Cursive", Font.PLAIN, 30));
		g.drawString("Level: " + spawner.getLevel(), 40, 40);
