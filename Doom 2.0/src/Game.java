...
public class Game implements Runnable{
	...
	public void init()
	{ 
		AudioLoader.getSingletonInstance();
		AudioLoader.play("res\\Sounds\\doom.wav");
		...
		// Se crea al jugador
		player = new Player(100, 200, 96, 96, null, null, handler);
	...
	public void render()
	{
		...
		g.drawString("Lvl:" + spawner.getLevel() + " | HP:" + player.getHealth(), 550, 40);
